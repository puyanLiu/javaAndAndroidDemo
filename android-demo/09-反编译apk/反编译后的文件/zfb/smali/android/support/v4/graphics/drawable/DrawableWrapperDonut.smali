...
.method private a([I)Z
    ...
    iget-object v2, p0, Landroid/support/v4/graphics/drawable/DrawableWrapperDonut;->a:Landroid/content/res/ColorStateList;
    ...
    iget-object v3, p0, Landroid/support/v4/graphics/drawable/DrawableWrapperDonut;->a:Landroid/content/res/ColorStateList;
    ...
    iget-object v3, p0, Landroid/support/v4/graphics/drawable/DrawableWrapperDonut;->b:Landroid/graphics/PorterDuff$Mode;

    iget-boolean v4, p0, Landroid/support/v4/graphics/drawable/DrawableWrapperDonut;->e:Z

    if-eqz v4, :cond_0

    iget v4, p0, Landroid/support/v4/graphics/drawable/DrawableWrapperDonut;->c:I

    if-ne v2, v4, :cond_0

    iget-object v4, p0, Landroid/support/v4/graphics/drawable/DrawableWrapperDonut;->d:Landroid/graphics/PorterDuff$Mode;
    ...
    iput v2, p0, Landroid/support/v4/graphics/drawable/DrawableWrapperDonut;->c:I

    iput-object v3, p0, Landroid/support/v4/graphics/drawable/DrawableWrapperDonut;->d:Landroid/graphics/PorterDuff$Mode;

    iput-boolean v0, p0, Landroid/support/v4/graphics/drawable/DrawableWrapperDonut;->e:Z
