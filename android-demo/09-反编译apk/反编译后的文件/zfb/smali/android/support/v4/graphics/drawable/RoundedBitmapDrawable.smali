...
.method constructor <init>(Landroid/content/res/Resources;Landroid/graphics/Bitmap;)V
    ...
    iput v0, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->a:I
    ...
    iput-object v0, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->c:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/Matrix;

    invoke-direct {v0}, Landroid/graphics/Matrix;-><init>()V

    iput-object v0, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->e:Landroid/graphics/Matrix;
    ...
    iput-object v0, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->g:Landroid/graphics/RectF;

    const/4 v0, 0x1

    iput-boolean v0, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->h:Z
    ...
    invoke-direct {p0}, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->a()V
    ...
    iput-object v0, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->d:Landroid/graphics/BitmapShader;
...
.method private a()V
    ...
    iget v1, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->a:I
...
.method private b()V
    ...
    iget v1, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->j:I
    ...
    iput v0, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->f:F
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->c:Landroid/graphics/Paint;
    ...
    iget-object v3, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->c:Landroid/graphics/Paint;
    ...
    :cond_1
    iget-object v0, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->g:Landroid/graphics/RectF;
...
.method public getAlpha()I
    ...
    iget-object v0, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->c:Landroid/graphics/Paint;
...
.method public getOpacity()I
    ...
    iget-boolean v1, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->i:Z
...
.method public setCircular(Z)V
    ...
    iget-object v1, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->d:Landroid/graphics/BitmapShader;
...
.method public setCornerRadius(F)V
    ...
    :goto_1
    iput p1, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->f:F
...
.method public setTargetDensity(I)V
    ...
    iget v0, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->a:I
    ...
    :cond_0
    iput p1, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->a:I
...
.method updateDstRect()V
    ...
    iget-boolean v0, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->h:Z
    ...
    iget-object v0, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->d:Landroid/graphics/BitmapShader;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->e:Landroid/graphics/Matrix;

    iget-object v1, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->g:Landroid/graphics/RectF;

    iget v1, v1, Landroid/graphics/RectF;->left:F

    iget-object v2, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->g:Landroid/graphics/RectF;
    ...
    iget-object v1, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->e:Landroid/graphics/Matrix;
    ...
    :cond_0
    iput-boolean v6, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->h:Z
