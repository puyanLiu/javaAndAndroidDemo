...
.field private u:Landroid/support/v4/widget/DrawerLayout$DrawerListener;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/DrawerLayout$ViewDragCallback;
    ...
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/DrawerLayout$ViewDragCallback;
    ...
    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/ViewDragHelper;

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/ViewDragHelper;
    ...
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->m:Landroid/support/v4/widget/DrawerLayout$ViewDragCallback;
...
.method private static a(Landroid/graphics/drawable/Drawable;I)Z
    ...
    :cond_1
    invoke-static {p0, p1}, Landroid/support/v4/graphics/drawable/DrawableCompat;->setLayoutDirection(Landroid/graphics/drawable/Drawable;I)V
...
.method closeDrawers(Z)V
    ...
    iget-object v7, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/ViewDragHelper;
    ...
    :cond_2
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/ViewDragHelper;
...
.method dispatchOnDrawerClosed(Landroid/view/View;)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->u:Landroid/support/v4/widget/DrawerLayout$DrawerListener;
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v5, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/ViewDragHelper;
...
.method protected onMeasure(II)V
    ...
    iget-object v10, p0, Landroid/support/v4/widget/DrawerLayout;->C:Ljava/lang/Object;
...
.method public setDrawerListener(Landroid/support/v4/widget/DrawerLayout$DrawerListener;)V
    ...
    iput-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->u:Landroid/support/v4/widget/DrawerLayout$DrawerListener;
