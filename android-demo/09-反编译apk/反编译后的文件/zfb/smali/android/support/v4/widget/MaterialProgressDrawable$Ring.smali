...
.method public draw(Landroid/graphics/Canvas;Landroid/graphics/Rect;)V
    ...
    iget-wide v4, p0, Landroid/support/v4/widget/MaterialProgressDrawable$Ring;->r:D
    ...
    iget-object v5, p0, Landroid/support/v4/widget/MaterialProgressDrawable$Ring;->p:Landroid/graphics/Path;

    invoke-virtual {v5, v8, v8}, Landroid/graphics/Path;->moveTo(FF)V

    iget-object v5, p0, Landroid/support/v4/widget/MaterialProgressDrawable$Ring;->p:Landroid/graphics/Path;

    iget v6, p0, Landroid/support/v4/widget/MaterialProgressDrawable$Ring;->s:I

    int-to-float v6, v6

    iget v7, p0, Landroid/support/v4/widget/MaterialProgressDrawable$Ring;->q:F
    ...
    iget v7, p0, Landroid/support/v4/widget/MaterialProgressDrawable$Ring;->t:I

    int-to-float v7, v7

    iget v8, p0, Landroid/support/v4/widget/MaterialProgressDrawable$Ring;->q:F
