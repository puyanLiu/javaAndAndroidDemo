...
.method private a(Ljava/util/Map;)V
    ...
    const-string/jumbo v2, "\u6ca1\u6709\u53ef\u5904\u7406receiver\uff0c\u5524\u8d77\u4e0b\u8f7d"
    ...
    const-string/jumbo v2, "call browser to download new"
...
.method public doReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-virtual {p0, v8}, Lcom/alipay/mobile/command/trigger/NotifyTrigger;->getResultExtras(Z)Landroid/os/Bundle;
    ...
    const-string/jumbo v4, "\u4e2areceiver\u5f85\u5904\u7406"
    ...
    const-string/jumbo v4, "remian:%s, notificationFlag:%s, notificationBody:%s"
    ...
    const-string/jumbo v1, "\u6307\u5b9a\u4e86NOTIFY_RECEIVER,\u4f46\u662f\u8ddf\u5f53\u524d\u5305\u540d\u4e0d\u5339\u914d"
    ...
    const-string/jumbo v1, "\u4e0d\u662fcountdown\u89e6\u53d1\uff0c\u76f4\u63a5todo"
