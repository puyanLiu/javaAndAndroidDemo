...
.method private a(Landroid/content/Context;)Ljava/lang/String;
    ...
    const-string/jumbo v2, "getCurProcessName: "
...
.method public decrypt(Landroid/database/Cursor;II)Lcom/alipay/mobile/security/gesture/GestureConfigDBItem;
    .locals 6
    ...
    invoke-static {v4, v2}, Lcom/alipay/mobilesecurity/taobao/sso/util/TaobaoSecurityEncryptor;->dynamicDecrypt(Landroid/content/ContextWrapper;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_3
    invoke-static {v0}, Lcom/alipay/mobile/security/gesture/util/GesutreContainUtil;->getAhead8BytesStr(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    invoke-static {v2, v0}, Lcom/alipay/mobile/common/security/Des;->decrypt(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_1
    invoke-virtual {v0, v3}, Lcom/alipay/mobile/security/gesture/GestureConfigDBItem;->setUdrtif(Ljava/lang/String;)V
...
.method public getAllConfigs()Ljava/util/List;
    ...
    const-class v10, Lcom/alipay/mobile/security/gesture/data/GestureConfigHelper;
    ...
    const-string/jumbo v0, "com.eg.android.AlipayGphone:phonecashier"
    ...
    invoke-direct {p0, v1}, Lcom/alipay/mobile/security/gesture/data/GestureConfigHelper;->a(Landroid/content/Context;)Ljava/lang/String;
    ...
    const-string/jumbo v0, "isInPhoneCashierProcess getAllConfigs return empty"
    ...
    :cond_0
    const-string/jumbo v0, "is not InPhoneCashierProcess getAllConfigs"
    ...
    invoke-virtual {v0}, Lcom/alipay/mobile/framework/service/ext/dbhelper/ClientDataBaseHelper;->getReadableDatabase()Lcom/alibaba/sqlcrypto/sqlite/SQLiteDatabase;

    move-result-object v0

    const-string/jumbo v1, "hrdyutr"
    ...
    const-string/jumbo v0, "decrypt end"

    invoke-virtual {p0, v0}, Lcom/alipay/mobile/security/gesture/data/GestureConfigHelper;->l(Ljava/lang/String;)V

    const-string/jumbo v0, "get all end"
    ...
    invoke-virtual {p0, v0, v1, v2}, Lcom/alipay/mobile/security/gesture/data/GestureConfigHelper;->decrypt(Landroid/database/Cursor;II)Lcom/alipay/mobile/security/gesture/GestureConfigDBItem;
