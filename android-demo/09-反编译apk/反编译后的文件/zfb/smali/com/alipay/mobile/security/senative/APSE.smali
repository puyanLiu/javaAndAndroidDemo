...
.field public static _instance:Lcom/alipay/mobile/security/senative/APSE;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/alipay/mobile/security/senative/APSE;->a:[I

    const/4 v0, 0x0

    sput-boolean v0, Lcom/alipay/mobile/security/senative/APSE;->b:Z

    :try_start_0
    const-string/jumbo v0, "APSE_1.0.5"
...
.method public static HOTP([BJI)Ljava/lang/String;
    ...
    :cond_0
    invoke-static {p0, v2}, Lcom/alipay/mobile/security/senative/APSE;->a([B[B)[B
    ...
    :cond_1
    sget-object v2, Lcom/alipay/mobile/security/senative/APSE;->a:[I
...
.method public static declared-synchronized getInstance(Landroid/content/Context;)Lcom/alipay/mobile/security/senative/APSE;
    ...
    sget-boolean v0, Lcom/alipay/mobile/security/senative/APSE;->b:Z

    if-nez v0, :cond_0

    new-instance v0, Lcom/alipay/mobile/security/senative/SEProtectLoaderEx;

    invoke-direct {v0, p0}, Lcom/alipay/mobile/security/senative/SEProtectLoaderEx;-><init>(Landroid/content/Context;)V

    const-string/jumbo v2, "APSE"

    const-string/jumbo v3, "1.0.5"

    invoke-virtual {v0, v2, v3}, Lcom/alipay/mobile/security/senative/SEProtectLoaderEx;->loadSo(Ljava/lang/String;Ljava/lang/String;)Z
