...
.field private d:Landroid/support/v7/widget/RecyclerView$RecycledViewPool;

.field private e:Landroid/support/v7/widget/RecyclerView$ViewCacheExtension;
...
.method public constructor <init>(Landroid/support/v7/widget/RecyclerView;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView$Recycler;->b:Ljava/util/List;

    const/4 v0, 0x2

    iput v0, p0, Landroid/support/v7/widget/RecyclerView$Recycler;->c:I
...
.method public final bindViewToPosition(Landroid/view/View;I)V
    ...
    invoke-direct {p0, p1}, Landroid/support/v7/widget/RecyclerView$Recycler;->a(Landroid/view/View;)V
...
.method final getRecycledViewPool()Landroid/support/v7/widget/RecyclerView$RecycledViewPool;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView$Recycler;->d:Landroid/support/v7/widget/RecyclerView$RecycledViewPool;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView$Recycler;->d:Landroid/support/v7/widget/RecyclerView$RecycledViewPool;
...
.method public final getScrapList()Ljava/util/List;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView$Recycler;->b:Ljava/util/List;
...
.method final getScrapViewForPosition(IIZ)Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    const-string/jumbo v3, " isn\'t dirty but has wrong view type! (found "
...
.method final getViewForPosition(IZ)Landroid/view/View;
    ...
    invoke-virtual {p0, v6, v7, v4, p2}, Landroid/support/v7/widget/RecyclerView$Recycler;->getScrapViewForId(JIZ)Landroid/support/v7/widget/RecyclerView$ViewHolder;

    move-result-object v0

    if-eqz v0, :cond_9

    iput v5, v0, Landroid/support/v7/widget/RecyclerView$ViewHolder;->mPosition:I
    ...
    iget-object v6, p0, Landroid/support/v7/widget/RecyclerView$Recycler;->e:Landroid/support/v7/widget/RecyclerView$ViewCacheExtension;

    if-eqz v6, :cond_b

    iget-object v6, p0, Landroid/support/v7/widget/RecyclerView$Recycler;->e:Landroid/support/v7/widget/RecyclerView$ViewCacheExtension;

    invoke-virtual {v6, p0, p1, v4}, Landroid/support/v7/widget/RecyclerView$ViewCacheExtension;->getViewForPositionAndType(Landroid/support/v7/widget/RecyclerView$Recycler;II)Landroid/view/View;
    ...
    invoke-virtual {v0, v4}, Landroid/support/v7/widget/RecyclerView$RecycledViewPool;->getRecycledView(I)Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    invoke-virtual {v6, v5}, Landroid/support/v7/widget/RecyclerView$Adapter;->getItemViewType(I)I
    ...
    invoke-direct {p0, v0}, Landroid/support/v7/widget/RecyclerView$Recycler;->a(Landroid/view/View;)V
...
.method final recycleViewHolderInternal(Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
    ...
    iget v3, p0, Landroid/support/v7/widget/RecyclerView$Recycler;->c:I
...
.method final scrapView(Landroid/view/View;)V
    ...
    iput-object v1, p0, Landroid/support/v7/widget/RecyclerView$Recycler;->a:Ljava/util/ArrayList;
...
.method final setRecycledViewPool(Landroid/support/v7/widget/RecyclerView$RecycledViewPool;)V
    ...
    :cond_0
    iput-object p1, p0, Landroid/support/v7/widget/RecyclerView$Recycler;->d:Landroid/support/v7/widget/RecyclerView$RecycledViewPool;
...
.method final setViewCacheExtension(Landroid/support/v7/widget/RecyclerView$ViewCacheExtension;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/RecyclerView$Recycler;->e:Landroid/support/v7/widget/RecyclerView$ViewCacheExtension;
...
.method public final setViewCacheSize(I)V
    ...
    iput p1, p0, Landroid/support/v7/widget/RecyclerView$Recycler;->c:I
