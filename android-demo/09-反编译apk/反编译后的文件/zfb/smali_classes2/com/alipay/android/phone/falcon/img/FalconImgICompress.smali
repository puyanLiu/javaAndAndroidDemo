...
.method public GenerateCompressImage_new(Ljava/io/File;III)Ljava/io/ByteArrayOutputStream;
    ...
    invoke-virtual {v5, v9, v12, v8}, Landroid/graphics/Bitmap;->compress(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    :try_end_a
    ...
    const-string/jumbo v14, "FalconImg"

    new-instance v15, Ljava/lang/StringBuilder;

    const-string/jumbo v19, "compress with file out of memory,OldInsampleSize: "
    ...
    invoke-interface {v13, v14, v15}, Lcom/alipay/mobile/common/logging/api/trace/TraceLogger;->debug(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_c
    .catchall {:try_start_c .. :try_end_c} :catchall_7
    ...
    invoke-virtual {v0, v11, v14, v15}, Lcom/alipay/android/phone/falcon/img/FalconImgICompress;->doCallBack(IIZ)V
    ...
    invoke-static {v11, v14, v6}, Landroid/graphics/BitmapFactory;->decodeFileDescriptor(Ljava/io/FileDescriptor;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v8, v6, v0}, Lcom/alipay/android/phone/falcon/img/dataFormat;->ScaleRotateImg(Landroid/graphics/Bitmap;FI)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {v7, v6, v10, v11}, Landroid/graphics/Bitmap;->compress(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    ...
    :try_start_11
    invoke-virtual {v9, v15}, Ljava/io/DataOutputStream;->write([B)V
    ...
    const-string/jumbo v12, "FalconImg"

    new-instance v13, Ljava/lang/StringBuilder;

    const-string/jumbo v14, "compress with file out of memory,OldInsampleSize: "
    ...
    invoke-interface {v6, v12, v5}, Lcom/alipay/mobile/common/logging/api/trace/TraceLogger;->debug(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_14
...
.method public doCallBack(IIZ)V
    ...
    const-string/jumbo v3, "BITMAP_SIZE:tmp_w="
