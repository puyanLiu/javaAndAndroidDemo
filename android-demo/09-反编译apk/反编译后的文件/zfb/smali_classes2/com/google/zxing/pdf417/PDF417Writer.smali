...
.method public final encode(Ljava/lang/String;Lcom/google/zxing/BarcodeFormat;IILjava/util/Map;)Lcom/google/zxing/common/BitMatrix;
    ...
    :cond_0
    new-instance v6, Lcom/google/zxing/pdf417/encoder/PDF417;

    invoke-direct {v6}, Lcom/google/zxing/pdf417/encoder/PDF417;-><init>()V
    ...
    invoke-virtual {v6, v0}, Lcom/google/zxing/pdf417/encoder/PDF417;->setCompact(Z)V
    ...
    invoke-virtual {v6, v0}, Lcom/google/zxing/pdf417/encoder/PDF417;->setCompaction(Lcom/google/zxing/pdf417/encoder/Compaction;)V
    ...
    invoke-virtual {v6, v4, v5, v7, v0}, Lcom/google/zxing/pdf417/encoder/PDF417;->setDimensions(IIII)V
    ...
    invoke-virtual {v6, v0}, Lcom/google/zxing/pdf417/encoder/PDF417;->setEncoding(Ljava/nio/charset/Charset;)V

    :cond_5
    invoke-virtual {v6, p1, v8}, Lcom/google/zxing/pdf417/encoder/PDF417;->generateBarcodeLogic(Ljava/lang/String;I)V

    invoke-virtual {v6}, Lcom/google/zxing/pdf417/encoder/PDF417;->getBarcodeMatrix()Lcom/google/zxing/pdf417/encoder/BarcodeMatrix;

    move-result-object v0

    const/16 v4, 0x8

    invoke-virtual {v0, v8, v4}, Lcom/google/zxing/pdf417/encoder/BarcodeMatrix;->getScaledMatrix(II)[[B
    ...
    invoke-static {v4}, Lcom/google/zxing/pdf417/PDF417Writer;->a([[B)[[B
    ...
    invoke-virtual {v2, v4, v3}, Lcom/google/zxing/pdf417/encoder/BarcodeMatrix;->getScaledMatrix(II)[[B

    move-result-object v2

    if-eqz v0, :cond_9

    invoke-static {v2}, Lcom/google/zxing/pdf417/PDF417Writer;->a([[B)[[B

    move-result-object v0

    :goto_4
    invoke-static {v0, v1}, Lcom/google/zxing/pdf417/PDF417Writer;->a([[BI)Lcom/google/zxing/common/BitMatrix;
    ...
    :cond_8
    invoke-static {v4, v1}, Lcom/google/zxing/pdf417/PDF417Writer;->a([[BI)Lcom/google/zxing/common/BitMatrix;
