...
# instance fields
.field next:Lorg/objectweb/asm/Attribute;
...
.method final getCount()I
    ...
    iget-object p0, p0, Lorg/objectweb/asm/Attribute;->next:Lorg/objectweb/asm/Attribute;
...
.method final getSize(Lorg/objectweb/asm/ClassWriter;[BIII)I
    .locals 7
    ...
    iget-object v0, v0, Lorg/objectweb/asm/Attribute;->next:Lorg/objectweb/asm/Attribute;
...
.method final put(Lorg/objectweb/asm/ClassWriter;[BIIILorg/objectweb/asm/ByteVector;)V
    .locals 6
    ...
    iget v3, v1, Lorg/objectweb/asm/ByteVector;->length:I
...
.method protected read(Lorg/objectweb/asm/ClassReader;II[CI[Lorg/objectweb/asm/Label;)Lorg/objectweb/asm/Attribute;
    ...
    iput-object v1, v0, Lorg/objectweb/asm/Attribute;->value:[B

    iget-object v1, p1, Lorg/objectweb/asm/ClassReader;->b:[B

    iget-object v2, v0, Lorg/objectweb/asm/Attribute;->value:[B
...
.method protected write(Lorg/objectweb/asm/ClassWriter;[BIII)Lorg/objectweb/asm/ByteVector;
    ...
    iget-object v1, p0, Lorg/objectweb/asm/Attribute;->value:[B

    iput-object v1, v0, Lorg/objectweb/asm/ByteVector;->data:[B

    iget-object v1, p0, Lorg/objectweb/asm/Attribute;->value:[B

    array-length v1, v1

    iput v1, v0, Lorg/objectweb/asm/ByteVector;->length:I
