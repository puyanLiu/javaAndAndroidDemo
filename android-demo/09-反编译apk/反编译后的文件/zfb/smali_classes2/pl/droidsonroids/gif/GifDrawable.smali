...
# static fields
.field private static final DISCARD_POLICY:Ljava/util/concurrent/ThreadPoolExecutor$DiscardPolicy;


# instance fields
.field private final mBuffer:Landroid/graphics/Bitmap;
...
.field private final mNativeInfoHandle:Lpl/droidsonroids/gif/GifInfoHandle;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lpl/droidsonroids/gif/GifDrawable;->DISCARD_POLICY:Ljava/util/concurrent/ThreadPoolExecutor$DiscardPolicy;
...
.method public constructor <init>(Landroid/content/res/AssetFileDescriptor;)V
    ...
    invoke-direct {p0, v0, v1, v2, v3}, Lpl/droidsonroids/gif/GifDrawable;-><init>(Lpl/droidsonroids/gif/GifInfoHandle;JLpl/droidsonroids/gif/GifDrawable;)V
...
.method constructor <init>(Lpl/droidsonroids/gif/GifInfoHandle;JLpl/droidsonroids/gif/GifDrawable;)V
    .locals 6
    ...
    sget-object v1, Lpl/droidsonroids/gif/GifDrawable;->DISCARD_POLICY:Ljava/util/concurrent/ThreadPoolExecutor$DiscardPolicy;
    ...
    iput-object v0, p0, Lpl/droidsonroids/gif/GifDrawable;->mExecutor:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
    ...
    iput-object v0, p0, Lpl/droidsonroids/gif/GifDrawable;->mNotifyListenersTask:Ljava/lang/Runnable;

    iput-object p1, p0, Lpl/droidsonroids/gif/GifDrawable;->mNativeInfoHandle:Lpl/droidsonroids/gif/GifInfoHandle;

    iput-wide p2, p0, Lpl/droidsonroids/gif/GifDrawable;->mInputSourceLength:J

    const/4 v0, 0x0

    if-eqz p4, :cond_1

    iget-object v1, p4, Lpl/droidsonroids/gif/GifDrawable;->mNativeInfoHandle:Lpl/droidsonroids/gif/GifInfoHandle;

    monitor-enter v1

    :try_start_0
    iget-object v2, p4, Lpl/droidsonroids/gif/GifDrawable;->mNativeInfoHandle:Lpl/droidsonroids/gif/GifInfoHandle;
    ...
    iget-object v2, p4, Lpl/droidsonroids/gif/GifDrawable;->mBuffer:Landroid/graphics/Bitmap;

    invoke-virtual {v2}, Landroid/graphics/Bitmap;->getHeight()I

    move-result v2

    iget-object v3, p4, Lpl/droidsonroids/gif/GifDrawable;->mBuffer:Landroid/graphics/Bitmap;
    ...
    invoke-direct {p4}, Lpl/droidsonroids/gif/GifDrawable;->shutdown()V

    iget-object v0, p4, Lpl/droidsonroids/gif/GifDrawable;->mBuffer:Landroid/graphics/Bitmap;
...
.method static synthetic access$0(Lpl/droidsonroids/gif/GifDrawable;)Z
    .locals 1
...
.method static synthetic access$1(Lpl/droidsonroids/gif/GifDrawable;)Lpl/droidsonroids/gif/GifInfoHandle;
    .locals 1
...
.method static synthetic access$2(Lpl/droidsonroids/gif/GifDrawable;)Landroid/graphics/Bitmap;
    .locals 1
...
.method static synthetic access$3(Lpl/droidsonroids/gif/GifDrawable;)Ljava/util/concurrent/ConcurrentLinkedQueue;
    .locals 1
...
.method static synthetic access$4(Lpl/droidsonroids/gif/GifDrawable;)Ljava/lang/Runnable;
    .locals 1

    iget-object v0, p0, Lpl/droidsonroids/gif/GifDrawable;->mNotifyListenersTask:Ljava/lang/Runnable;

    return-object v0
.end method

.method static synthetic access$5(Lpl/droidsonroids/gif/GifDrawable;)Ljava/util/concurrent/ScheduledThreadPoolExecutor;
    .locals 1
...
.method static synthetic access$6(Lpl/droidsonroids/gif/GifDrawable;)Ljava/lang/Runnable;
    .locals 1
...
.method static synthetic access$7(Lpl/droidsonroids/gif/GifDrawable;)Ljava/lang/Runnable;
    .locals 1

    iget-object v0, p0, Lpl/droidsonroids/gif/GifDrawable;->mRenderTask:Ljava/lang/Runnable;
...
.method private shutdown()V
    ...
    invoke-virtual {p0, v0}, Lpl/droidsonroids/gif/GifDrawable;->unscheduleSelf(Ljava/lang/Runnable;)V
...
.method public getNumberOfFrames()I
    ...
    iget v0, v0, Lpl/droidsonroids/gif/GifInfoHandle;->imageCount:I
...
.method public reset()V
    ...
    new-instance v1, Lpl/droidsonroids/gif/GifDrawable$5;

    invoke-direct {v1, p0}, Lpl/droidsonroids/gif/GifDrawable$5;-><init>(Lpl/droidsonroids/gif/GifDrawable;)V
...
.method public seekTo(I)V
    ...
    new-instance v1, Lpl/droidsonroids/gif/GifDrawable$7;

    invoke-direct {v1, p0, p1}, Lpl/droidsonroids/gif/GifDrawable$7;-><init>(Lpl/droidsonroids/gif/GifDrawable;I)V
...
.method public seekToFrame(I)V
    ...
    new-instance v1, Lpl/droidsonroids/gif/GifDrawable$8;

    invoke-direct {v1, p0, p1}, Lpl/droidsonroids/gif/GifDrawable$8;-><init>(Lpl/droidsonroids/gif/GifDrawable;I)V
...
.method public start()V
    ...
    new-instance v1, Lpl/droidsonroids/gif/GifDrawable$4;

    invoke-direct {v1, p0}, Lpl/droidsonroids/gif/GifDrawable$4;-><init>(Lpl/droidsonroids/gif/GifDrawable;)V
...
.method public stop()V
    ...
    new-instance v1, Lpl/droidsonroids/gif/GifDrawable$6;

    invoke-direct {v1, p0}, Lpl/droidsonroids/gif/GifDrawable$6;-><init>(Lpl/droidsonroids/gif/GifDrawable;)V
...
.method public toString()Ljava/lang/String;
    ...
    iget v4, v4, Lpl/droidsonroids/gif/GifInfoHandle;->imageCount:I
